...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // In each call, print remaining to UI
...
// console.log('FR: ', new Intl.NumberFormat('fr-FR', options).format(num));
// console.log('BJ: ', new Intl.NumberFormat('fr-BJ', options).format(num));
